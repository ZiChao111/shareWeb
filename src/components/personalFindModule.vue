<!--
 * @Author: your name
 * @Date: 2021-02-17 20:08:04
 * @LastEditTime: 2021-02-26 13:53:46
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \yuzhoujiandui\src\components\personalFindModule.vue
-->
<template>
  <div>
      ...
      <el-card class="box-card-commodity">
        ...
        <div>
          ...
          <el-button type="text" icon="el-icon-delete" circle style="padding-left: 34%" 
                               @click="deletePost(item.item_id)">删除</el-button>
          <!--          用户名-->
